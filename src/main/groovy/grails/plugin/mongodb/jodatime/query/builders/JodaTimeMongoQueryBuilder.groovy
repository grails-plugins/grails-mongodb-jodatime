package grails.plugin.mongodb.jodatime.query.builders
...
class JodaTimeMongoQueryBuilder {
    ...
    void buildQuery(PersistentProperty property, String key, String type, Query.PropertyCriterion criterion, Document nativeQuery) {
    ...
    boolean build(PersistentProperty property, String key, String type, Between criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, Equals criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, NotEquals criterion, Document nativeQuery, Date fromDt, Date toDt) {
        ...
        Document ltDbo = new BasicDBObject()
    ...
    boolean build(PersistentProperty property, String key, String type, LessThan criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, LessThanEquals criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, GreaterThan criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, GreaterThanEquals criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, IsNotNull criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, IsNull criterion, Document nativeQuery, Date fromDt, Date toDt) {
    ...
    boolean build(PersistentProperty property, String key, String type, Query.PropertyCriterion criterion, Document nativeQuery, Date fromDt, Date toDt) {
        return false
    }
}